  ...
  return (
    <div className="publicationsContainer">
      <Metadata
        ...
        children={
          <div>
            ...
            <PublicationItem
              ...
              title="Use the Force Picker, Luke: Space-Efficient Value Input on
            Force-Sensitive Mobile Touchscreens"
              publishedIn="In Proceedings of the 2018 CHI Conference on Human
            Factors in Computing Systems, CHI '18, pages 661:1–661:12, ACM"
            ...
            <PublicationItem
              ...
              title="Bidirectional Force Input: Increasing and Decreasing Values on
        Mobile Devices with the Thumb"
        ...
        Input"
              publishedIn="In Proceedings of the 18th International Conference on
        Human-Computer Interaction with Mobile Devices and Services, MobileHCI '16, pages 185–189, ACM"
              location="New York, NY, USA"
              date="September 2016"
