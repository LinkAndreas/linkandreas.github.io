...
![Manifest Processing Pipeline](flow.png)
...
Having referred to the _processing pipeline_ as the main driver of the app, let's focus on the UI as well as the challenges that I faced when bringing _Licenses_ to the Mac.
